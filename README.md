...
Jika ada minimal dua pemain, item power-up ×3 dan ×5 muncul bergantian di antara deret pipa. Pemain yang mengambil item dapat menyimpan satu item dan mengaktifkannya lewat tombol ⚡ atau tombol `E`. Selama 4 detik, pemain lain harus mengetuk 3 atau 5 kali untuk satu kepakan. Pemilik item tidak terkena efek itemnya sendiri.
